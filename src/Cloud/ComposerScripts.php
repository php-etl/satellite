...
use Kiboko\Component\Satellite\Cloud\Composer\Accumulator;
...
final class ComposerScripts
{
    ...
    private static function updatePlugins(
        ...
        foreach ($repository->getPackages() as $package) {
            ...
            if (!isset($package->getExtra()['satellite']['class'])
                ...
                $io->error(strtr(
                    ...
                    .' or extra.gyroscops.runtimes parameters in your composer.json file. The'
            ...
            if (isset($package->getExtra()['satellite']['class'])) {
                $io->warning(strtr(
                    'The package %package% is using a deprecated configuration: extras.satellite.class, you may upgrade'
                        .' it to use the extra.gyroscops.plugins or extra.gyroscops.runtimes'
        ...
        file_put_contents('.cloud.php', $packages);
    }
}
