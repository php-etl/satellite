...
#[Feature(name: 'rejection')] final readonly class Service implements Configurator\PipelineFeatureInterface
{
        ...
        try {
            ...
            foreach ($config['destinations'] as $destination) {
                if (\array_key_exists('rabbitmq', $destination)) {
                    ...
                    $builder->withRejection($rabbitmqRepository->getBuilder()->getNode());
                }
            }
