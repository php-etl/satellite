...
final class Factory implements FactoryInterface
{
    ...
    {
        if (array_key_exists('docker', $configuration["satellite"])) {
            $factory = new Satellite\Adapter\Docker\Factory();
        } elseif (array_key_exists('filesystem', $configuration["satellite"])) {
            $factory = new Satellite\Adapter\Filesystem\Factory();
        } elseif (array_key_exists('amazon_lambda', $configuration["satellite"])) {
            $factory = new Satellite\Adapter\AmazonLambda\Factory();
        } elseif (array_key_exists('google_cloud_function', $configuration["satellite"])) {
        ...
        return $factory($configuration["satellite"]);
    }
}
